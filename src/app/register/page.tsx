    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white manga-border shadow-[8px_8px_0_0_#000] p-8 rounded-3xl">
          ...
          <h1 className="text-3xl font-bold text-center text-slate-800 mb-2">สมัครสมาชิก</h1>
          <p className="text-center text-slate-500 mb-8 font-medium">สมัครสมาชิกเพื่อสั่งซื้อและดาวน์โหลดใบงาน</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {isLoading ? "กำลังดำเนินการ..." : (
                <>สมัครสมาชิก <ArrowRight className="w-5 h-5 ml-2" /></>
              )}
            </Button>
          </form>
